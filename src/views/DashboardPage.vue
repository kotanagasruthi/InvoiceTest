<template>
      ...
      <header>
        ...
        <div class="left-pane">
            ...
            <div class="menu-item">
                <i class="icon-swiggy-one"></i> Swiggy One
            </div>
            <div class="menu-item">
                <i class="icon-favourites"></i> Favourites
            </div>
            <div class="menu-item">
                <i class="icon-payments"></i> Payments
            </div>
            <div class="menu-item">
                <i class="icon-addresses"></i> Addresses
            </div>
            <div class="menu-item">
        ...
        <main>
            ...
            <!-- Add address blocks as needed -->
            <div class="address-block">Work: Details</div>
            <div class="address-block">Home: Details</div>
            <!-- ... -->
        </main>
    </div>
</template>
